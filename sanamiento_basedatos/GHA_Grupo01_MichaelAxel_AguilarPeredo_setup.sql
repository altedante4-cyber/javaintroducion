...
-- ============================================================
-- Script: SETUP
-- Descripción: Creación de la base de datos y carga de datos
--              "radiactivos" para saneamientos posteriores
-- ============================================================
...
('87654321-B', 'Maria Lopez Sanz', 'm.lopez@gmail,con', '611-222-333', '1992.08.15', NULL),
(' 11223344C ', '  LUIS MARTINEZ  ', 'luis@test@es', '0034622444555', '01-01-1975', 'POL-1122'),
('12345678A', 'Juan Carlos Ibañez', 'jc.ibanez@mail.com', '600111222', '12/05/1980', 'POL-9988'),
('22334455D', 'Ana Ruiz Pardo', NULL, NULL, '20/10/2005', NULL),
...
('44556677X', 'Sonia Valverde', 'sonia.v@outlook.com', '655999000', '15/03/1988', 'POL-5566'),
...
(2, 2, '2026.03.13 09:00', '$80.00', NULL, NULL),
(3, 1, '14-03-2026 11:15', ' 120,00 ', '5.50', 'Dolor muscular'),
(1, 1, '12/03/2026 10:30', '150.50€', '10.00', NULL),
...
SELECT 'SETUP completado: Base de datos y datos cargados' AS status;
